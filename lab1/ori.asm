...
test_successful:
    li a0, 1		# системный вызов: print_int - печать числа
    la a1, 0xB000	# загрузка в a1 значения для системного вызова 0xB000 = 45056
    ecall			# системный вызов
    j exit			# безусловный переход к меке exit

test_failed:
    li a0, 4		# системный вызов: print_character - печать символа
    li a1, 'N'		# загрузка в a1 значения для системного вызова символ N
	ecall			# системный вызов

exit:
li a0, 10 			# системный вызов: exit - остановка симулятора
ecall				# системный вызов
